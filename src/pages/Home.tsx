...
const criteriaOptions = [
  ...
  { id: "mascot", label: "Mascot", desc: "Who has the best mascot?" },
  {
    id: "alumni",
    label: "Famous Alumni",
    desc: "Which school has the best alumni?",
  },
];
  ...
  return (
    <div className="home-container" style={{ overflowY: "auto" }}>
      <main className="content" style={{ padding: "2rem 0" }}>
        ...
        <p>Pick based on school traits instead of "analytics".</p>
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontSize: "0.9rem", color: "#888" }}>
                          {new Date(b.completedAt).toLocaleDateString()} at{" "}
                          {new Date(b.completedAt).toLocaleTimeString()}
                        </div>
                      </div>
                      <div style={{ textAlign: "right" }}>
                        ...
                        <div
                          style={{
                            color: b.champion?.primaryColor || "#fff",
                            fontWeight: "bold",
                          }}
                        >
                          {b.champion?.name}
